...
if __name__ == "__main__":
    ...
    # Load captions
    with open(caption_file, 'r', encoding='utf-8') as file:
        captions = [line.strip().split('|')[1] for line in file.readlines()]
    ...
    model.initialize_fc1((3, 224, 224))  # Example image shape (3 channels, 224x224)
    ...
    metrics = train_and_validate(model, train_loader, val_loader, optimizer, scheduler, epochs=10, device="cuda")
